...
const CatalogPagination = ({catalogLength, active, scrollToRef}) => {
  ...
  return (
    <CatalogPaginationLine >
      <ReactCatalogPagination page={page} lastPage={Math.ceil(catalogLength / perPage)} active={active} pageInfo={`${page} из ${Math.ceil(catalogLength / perPage)}`}>
        <ReactPaginate
                ...
                onPageChange={(data) =>  {
                  ...
                  scrollTo(document.documentElement, getOffset(t).top - 40, 300)
                  dispatch({
